...
import { obtenerCocteleria, listarCocteleria } from '../actions/actionCocteleriaB';
...
const CocteleriaBSlice = createSlice({
  name: "getCocteleria",
  initialState,
  reducers: {},
...
export const getCocteleriaBReducer = CocteleriaBSlice.reducer;