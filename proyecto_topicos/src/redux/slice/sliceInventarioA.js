...
import { listarInventario, obtenerInventario } from '../actions/actionInventarioA';
...
const InventarioASlice = createSlice({
  name: "getInventario",
  initialState,
  reducers: {},
...
export const getInventarioAReducer = InventarioASlice.reducer;