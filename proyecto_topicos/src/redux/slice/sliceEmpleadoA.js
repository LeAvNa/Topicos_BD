...
import { listarEmpleado, obtenerEmpleado } from '../actions/actionEmpleadoA';
...
const EmpleadoASlice = createSlice({
  name: "getEmpleado",
  initialState,
  reducers: {},
...
export const getEmpleadoAReducer = EmpleadoASlice.reducer;