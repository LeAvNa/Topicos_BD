...
import { listarSucursal, obtenerSucursal } from '../actions/actionSucursalB';
...
const SucursalBSlice = createSlice({
  name: "sucursal",
  initialState,
  reducers: {},
...
export const getSucursalBReducer = SucursalBSlice.reducer;