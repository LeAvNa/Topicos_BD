...
public partial class Sucursal1Context : DbContext
{
    public Sucursal1Context()
    {
    }

    public Sucursal1Context(DbContextOptions<Sucursal1Context> options)
        : base(options)
    {
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdCat).HasName("PK__Categori__D54686DE0DF6E07B");
        ...
        {
            entity.HasKey(e => e.IdCliente).HasName("PK__Clientes__677F38F5E388A558");
        ...
        {
            entity.HasKey(e => e.IdCoct).HasName("PK__Cocteler__6D69ED69409127F8");
        ...
        modelBuilder.Entity<DetVenta>(entity =>
        {
            ...
            entity.HasOne(d => d.IdCoctNavigation).WithMany()
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__det_venta__id_co__5441852A");

            entity.HasOne(d => d.IdProdNavigation).WithMany()
                .HasForeignKey(d => d.IdProd)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__det_venta__id_pr__5535A963");

            entity.HasOne(d => d.IdVentaNavigation).WithMany()
                .HasForeignKey(d => d.IdVenta)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__det_venta__id_ve__5629CD9C");
        });

        modelBuilder.Entity<Empleado>(entity =>
        {
            entity.HasKey(e => e.IdEmpleado).HasName("PK__Empleado__88B51394502E152C");
        ...
        {
            entity.HasKey(e => e.IdEmpleado).HasName("PK__Empleado__88B51394B5F00E04");
        ...
        modelBuilder.Entity<Genera>(entity =>
        {
            ...
            entity.HasOne(d => d.IdClienteNavigation).WithMany()
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__genera__id_clien__4222D4EF");

            entity.HasOne(d => d.IdEmpleadoNavigation).WithMany()
                .HasForeignKey(d => d.IdEmpleado)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__genera__id_emple__4316F928");

            entity.HasOne(d => d.IdVentaNavigation).WithMany()
                .HasForeignKey(d => d.IdVenta)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__genera__id_venta__412EB0B6");
        });

        modelBuilder.Entity<Producto>(entity =>
        {
            entity.HasKey(e => e.IdProd).HasName("PK__Producto__0DA348735F2EF705");
            ...
            entity.HasOne(d => d.IdCatNavigation).WithMany(p => p.Productos)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Productos__id_ca__4CA06362");

            entity.HasOne(d => d.IdSubcatNavigation).WithMany(p => p.Productos)
                .HasForeignKey(d => d.IdSubcat)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Productos__id_su__4D94879B");
        });
        ...
        modelBuilder.Entity<Provee>(entity =>
        {
            ...
            entity.HasOne(d => d.IdProdNavigation).WithMany()
                .HasForeignKey(d => d.IdProd)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__provee__id_prod__5070F446");

            entity.HasOne(d => d.IdProvNavigation).WithMany()
                .HasForeignKey(d => d.IdProv)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__provee__id_prov__4F7CD00D");
        });

        modelBuilder.Entity<Proveedores>(entity =>
        {
            entity.HasKey(e => e.IdProv).HasName("PK__Proveedo__0DA3485DF8C06DB0");
        ...
        {
            entity.HasKey(e => e.IdSubcat).HasName("PK__Sub_Cate__73921916B3175717");
            ...
            entity.HasOne(d => d.IdCatNavigation).WithMany(p => p.SubCategoria)
                .HasForeignKey(d => d.IdCat)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Sub_Categ__id_ca__49C3F6B7");
        });

        modelBuilder.Entity<Sucursales>(entity =>
        {
            entity.HasKey(e => e.IdSucursal).HasName("PK__Sucursal__4C7580131FE6529B");
        ...
        {
            entity.HasKey(e => e.IdVenta).HasName("PK__Ventas__459533BFCB4016D9");
            ...
            entity.HasOne(d => d.IdSucursalNavigation).WithMany(p => p.Venta)
                .HasForeignKey(d => d.IdSucursal)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Ventas__id_sucur__3F466844");
        });
