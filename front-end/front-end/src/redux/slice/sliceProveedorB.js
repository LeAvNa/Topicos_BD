...
import { listarProveedor, obtenerProveedor } from '../actions/actionProveedorB';
...
const ProveedorBSlice = createSlice({
  name: "getProveedor",
  initialState,
  reducers: {},
...
export const getProveedorBReducer = ProveedorBSlice.reducer;